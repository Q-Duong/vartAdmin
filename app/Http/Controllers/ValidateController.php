...
class ValidateController extends Controller
{
    ...
    //Report
    public function validateReport($locale, $object_choses)
    {
        if ($locale == 'en') {
            $rules = [
                'en_report_firstname' => 'required|string|regex:/^([^0-9]*)$/',
    ...
    //Register
    public static function validateRegister($object_choses, $locale, $payment_method)
    {
        if ($locale == 'vn') {
            $rules = [
