                        ...
                        <div class="column small-12 large-10 large-centered">
                            <form id="hrtta">
                                ...
                                <div class="form-textbox">
                                    <input type="text" class="form-textbox-input" name="hrtta_title"
                                ...
                                <div class="form-textbox">
                                    <input type="text" class="form-textbox-input" name="hrtta_title_en"
                                        autocapitalize="off" autocomplete="off">
                                ...
                                <div class="form-textbox">
                                    <textarea name="hrtta_text" rows=8 class="form-textarea" id="editor3"></textarea>
                                ...
                                <div class="form-textbox">
                                    <textarea name="hrtta_text_en" rows=8 class="form-textarea" id="editor4"></textarea>
