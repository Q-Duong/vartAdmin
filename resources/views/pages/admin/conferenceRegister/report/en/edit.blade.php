                    ...
                    <div class="position-center">
                        <form id="update-form">
                            ...
                            <div class="form-dropdown">
                                <select class="form-dropdown-select" name="en_report_title">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-textbox">
                                        <input type="text" name="en_report_firstname"
                                            class="form-textbox-input {{ $en_report->en_report_firstname ? 'form-textbox-entered' : '' }}"
                                            value="{{ $en_report->en_report_firstname }}">
                                        <div class="form-message-wrapper en_report_firstname">
                                            <i class="fa fa-exclamation-circle"></i>
                                            <span class="en_report_firstname-form-message"></span>
                                        </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-textbox">
                                        <input type="text" name="en_report_lastname"
                                            class="form-textbox-input {{ $en_report->en_report_lastname ? 'form-textbox-entered' : '' }}"
                                            value="{{ $en_report->en_report_lastname }}">
                                        <div class="form-message-wrapper en_report_lastname">
                                            <i class="fa fa-exclamation-circle"></i>
                                            <span class="en_report_lastname-form-message"></span>
                                        </div>
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <div class="form-dropdown">
                                        <select class="form-dropdown-select" name="en_report_date">
                                            @for ($i = 1; $i <= 31; $i++)
                                                <option value="{{ $i }}"
                                ...
                                <div class="col-sm-4">
                                    <div class="form-dropdown">
                                        <select class="form-dropdown-select" name="en_report_month">
                                            @for ($i = 1; $i <= 12; $i++)
                                                <option value="{{ $i }}"
                                ...
                                <div class="col-sm-4">
                                    <div class="form-dropdown">
                                        <select class="form-dropdown-select" name="en_report_year">
                                            @for ($i = 1940; $i < 2010; $i++)
                                                <option value="{{ $i }}"
                            ...
                            <div class="form-textbox">
                                <input type="text" name="en_report_email"
                                    class="form-textbox-input {{ $en_report->en_report_email ? 'form-textbox-entered' : '' }}"
                                    value="{{ $en_report->en_report_email }}">
                                <div class="form-message-wrapper en_report_email">
                                    <i class="fa fa-exclamation-circle"></i>
                                    <span class="en_report_email-form-message"></span>
                                </div>
                                <span class="form-textbox-label">@lang('conference.en.email')</span>
                            </div>
                            <div class="form-dropdown">
                                <select class="form-dropdown-select" name="en_report_profession">
                                ...
                                <span class="form-dropdown-chevron" aria-hidden="true"><i
                                        class="fa-solid fa-angle-down"></i></span>
                                <span class="form-dropdown-label">@lang('conference.en.profession.profession')</span>
                            </div>
                            <div class="form-textbox">
                                <input type="text" name="en_report_organization"
                                    class="form-textbox-input {{ $en_report->en_report_organization ? 'form-textbox-entered' : '' }}"
                                    value="{{ $en_report->en_report_organization }}">
                                <div class="form-message-wrapper en_report_organization">
                                    <i class="fa fa-exclamation-circle"></i>
                                    <span class="en_report_organization-form-message"></span>
                                </div>
                                <span class="form-textbox-label">@lang('conference.en.organization')</span>
                            </div>
                            <div class="form-textbox">
                                <input type="text" name="en_report_department"
                                    class="form-textbox-input {{ $en_report->en_report_department ? 'form-textbox-entered' : '' }}"
                                    value="{{ $en_report->en_report_department }}">
                                <div class="form-message-wrapper en_report_department">
                                    <i class="fa fa-exclamation-circle"></i>
                                    <span class="en_report_department-form-message"></span>
                                </div>
                                <span class="form-textbox-label">@lang('conference.en.department')</span>
                            </div>
                            <div class="form-dropdown">
                                <select class="form-dropdown-select" name="en_report_nationality">
                            ...
                            <div class="form-textbox">
                                <input type="text" name="en_report_file_title"
                                    class="form-textbox-input {{ $en_report->en_report_file_title ? 'form-textbox-entered' : '' }}"
                                    value="{{ $en_report->en_report_file_title }}">
                                <div class="form-message-wrapper en_report_file_title">
                                    <i class="fa fa-exclamation-circle"></i>
                                    <span class="en_report_file_title-form-message"></span>
                                </div>
                            ...
                            <div class="form-dropdown">
                                <select class="form-dropdown-select" name="en_report_status">
