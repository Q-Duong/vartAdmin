...
@section('content')
    <div class="table-agile-info">
        <div class="panel-heading">
            @lang('conference.en.report_title') - {{ $conference->conference_title }}
        </div>
                    ...
                    <tbody>
                        @foreach ($getAllConferenceReport as $key => $report)
                            <tr>
                                ...
                                <td class="management">
                                    <a href="{{ Route('conference_report.edit', [$conference->conference_code, $report->id]) }}"
