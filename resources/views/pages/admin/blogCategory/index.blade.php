                    ...
                    <tbody class="list-content">
                        @foreach ($getAllBlogCategory as $key => $blogCategory)
                            <tr>
                                ...
                                <td class="management">
                                    <button type="button" onclick="updateContent('update', {{ $blogCategory->id }})"
                                        class="management-btn" title="@lang('vart_define.button.update')">
                                        <i class="fa fa-pencil-square-o text-success text-active"></i>
                                    </button>
                                    <button onclick="deleteContent({{ $blogCategory->id }})" class="management-btn"
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        var url_load_content = "{{ route('blog_category.load') }}";
        var url_get_form = "{{ route('blog_category.get_form') }}";
        var url_create_or_update = "{{ route('blog_category.store_or_update') }}";
        var url_delete = "{{ route('blog_category.destroy') }}";
        ...
        var main_content = 'blog_category';
