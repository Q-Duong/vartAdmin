                            ...
                            <form id="conference">
                                        ...
                                        <div class="img-thumb">
                                            <div class="thumb-main">
                                                <button type="button" class="delete-image-thumb"
                                                    onclick="deleteImage('conference', 'vn', {{ $conference->id }})">
                                ...
                                <div class="form-textbox">
                                    ...
                                    @if ($conference->conference_image_en)
                                        <input type="file" name="conference_image_en"
                                            class="filepond conference-image-en-filepond hidden">
                                        <div class="img-thumb-en">
                                            <div class="thumb-main">
                                                <button type="button" class="delete-image-thumb"
                                                    onclick="deleteImage('conference', 'en', {{ $conference->id }})">
                                                    <i class="fas fa-times icon"></i>
                                                </button>
                                    ...
                                    @else
                                        <input type="file" name="conference_image_en"
                                            class="filepond conference-image-en-filepond">
                                    @endif
                                </div>
                                <div class="form-dropdown">
                                ...
                                <div class="form-dropdown">
                                    <select class="form-dropdown-select" name="prioritize">
                                        <option value="0" {{ $conference->prioritize == 0 ? 'selected' : '' }}>Non</option>
