                    ...
                    <tbody class="list-content">
                        @foreach ($getAllHart as $key => $hart)
                            <tr>
                                ...
                                <td class="management">
                                    <button type="button" onclick="updateContent('update', {{ $hart->id }})"
                                        class="management-btn" title="@lang('vart_define.button.update')">
                                        <i class="fa fa-pencil-square-o text-success text-active"></i>
                                    </button>
                                    <button onclick="deleteContent({{ $hart->id }})" class="management-btn"
...
@push('js')
    ...
    <script type="text/javascript">
        ...
        var url_load_content = "{{ route('hart.load') }}";
        var url_get_form = "{{ route('hart.get_form') }}";
        var url_create_or_update = "{{ route('hart.store_or_update') }}";
        var url_delete = "{{ route('hart.destroy') }}";
