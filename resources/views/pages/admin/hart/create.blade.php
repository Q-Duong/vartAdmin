                        ...
                        <div class="column small-12 large-10 large-centered">
                            <form id="hart">
                                ...
                                <div class="form-textbox">
                                    <input type="text" class="form-textbox-input" name="hart_title"
                                ...
                                <div class="form-textbox">
                                    <input type="text" class="form-textbox-input" name="hart_title_en"
                                        autocapitalize="off" autocomplete="off">
                                ...
                                <div class="form-textbox">
                                    <textarea name="hart_text" rows=8 class="form-textarea" id="editor3"></textarea>
                                ...
                                <div class="form-textbox">
                                    <textarea name="hart_text_en" rows=8 class="form-textarea" id="editor4"></textarea>
