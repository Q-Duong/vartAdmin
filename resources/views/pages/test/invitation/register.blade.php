...
<body>
    <div class="main">
        ...
        <div class="content">
            ...
            <div>
                <h2 class="title">THƯ MỜI THAM DỰ</h2>
            </div>
            <div class="dear">
                <b>Kính mời:</b>
            </div>
            ...
            <div class="section-location">
                <div class="content-text-sub">
                    <span class="content-strong">Thời gian:</span> Ngày 05,06/12/2025 (Thứ Sáu và Thứ Bảy)
                </div>
                <div class="content-text-sub">
                ...
                <div class="content-text-sub">
                    Sự có mặt của Quý vị là niềm cổ vũ, động viên to lớn, góp phần quan trọng để tổ chức hội nghị thành
                    công.
                </div>
            </div>
            <div class="line"></div>
...
<body>
    <div class="main">
        ...
        <div class="content">
            <div class="block-title">
                <img src="{{ $imgLogo }}" class="title-logo">
                <h4 class="title-name">Hội kỹ thuật xạ trị Thành phố Hồ Chí Minh</h4>
            </div>
            <div>
