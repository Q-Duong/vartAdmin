    ...
    <div
        ...
        <div>
            <h3 style="text-align: center; color: #601e89;">
                GIẤY CHỨNG NHẬN CME HỘI NGHỊ 2025 - QUẢNG TRỊ
            </h3>
        </div>
        <div style="width: 86%; margin: 50px auto;">
            ...
            <div>
                <div style="margin-bottom: 25px; text-align: justify;">
                    <span style="margin-left: 30px;">Chi hội Kỹ Thuật Điện Quang & Y Học Hạt Nhân khu vực phía Bắc trân trọng
                        cảm ơn {{ $title == 0 ? 'Ông' : 'Bà' }} {{ $name }} đã quan tâm và đăng ký tham
                        dự.</span>
                    <div style="text-align: center;">
                        <br><b>"{{ $conference_title }}"</b>
                    </div>
                    <div style="margin-top: 25px;">Vui lòng mở file đính kèm: Giấy chứng nhận Hội nghị 2025 tại Quảng Trị.</div>
                </div>
                <div style="margin-bottom: 25px; text-align: justify;">
