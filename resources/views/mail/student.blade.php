            ...
            <div>
                <div style="margin-bottom: 25px; text-align: justify;">
                    <span style="margin-left: 30px;">Thay mặt Ban tổ chức, Chúng tôi trân trọng kính mời: <strong>Sinh
                            viên <span style=" text-transform: uppercase">{{ $register_name }}</span></strong></span>
                    <br>Đến tham dự:<strong> SINH HOẠT KHOA HỌC (SINH VIÊN)</strong> Ngày <strong>22/06 từ
                        8:30-17:30.</strong>
                ...
                <div style="margin-bottom: 25px; text-align: justify;">
                    Quý đại biểu có thể bấm vào đường <a href="https://vart.vn/invitation-letter"
                        target="_blank"><strong>Link</strong></a> và điền <strong>Mã code: {{ $register_code }}</strong>
