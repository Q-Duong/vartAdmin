...
<body
    ...
    <div
        ...
        <div style="display: flex; align-items: center;">
            ...
            <h4 style="text-align: left; text-transform: uppercase; font-size: 14px; margin-left: 10px;">
                CHI HỘI KỸ THUẬT XẠ TRỊ THÀNH PHỐ HỒ CHÍ MINH
            </h4>
        </div>
        ...
        <div style="width: 86%; margin: 50px auto;">
            ...
            <div>
                <div style="margin-bottom: 25px; text-align: justify; line-height: 1.38em;">
                    ...
                    <div style="margin-top: 15px; text-align: center; color: #27c24c;"><b>SINH HOẠT KHOA HỌC (SINH VIÊN)</b></div>
                    <div style="margin-top: 25px;"><b>Thời gian:</b> Ngày thứ Sáu 13/03/2026 từ 13:00-17:00 (Hội thảo
                        tiền hội nghị)</div>
                    <div style="margin-top: 1px;"><b style="color: #ffffff;">Thời gian:</b><b style="color: #f01c1c;">
                            Ngày thứ Bảy 14/03/2026 từ 8:00-17:00 (Hội nghị chính thức)</b></div>
                    <div style="margin-top: 15px;"><b>Địa điểm:</b> Hội trường Bệnh viện FV</div>
                    <div style="margin-top: 15px;"><b>Địa chỉ:</b> Số 06 Nguyễn Lương Bằng, Phường Tân Mỹ, TP. Hồ Chí
                        Minh</div>
                </div>
                <div style="margin-bottom: 25px; text-align: justify;">
                    ...
                    để lấy thư mời trong trường hợp bị mất thư mời.
                </div>
                <div style="margin-bottom: 25px; text-align: justify;">
                ...
                <div style="display: flex; align-items: center; justify-content: space-between">
                    <div style="width: 50%;">
                        <div style="text-align: center;"><strong>Hội Kỹ thuật Hình ảnh Y học TP. HCM</strong></div>
                    ...
                    <div style="width: 50%;">
                        ...
                        <div style="text-align: center;"><strong>CHỦ TỊCH</strong></div>
                        <img src="https://images.vart.vn/gmail/sign-hrtta.png"
                            style="height: 70px; width: 150px; margin-left: 70px">
                        <div style="text-align: center;"><strong>Ths. Phàng Đức Tín</strong></div>
                    </div>
                </div>
            </div>
        </div>
