    ...
    <div
        ...
        <div style="width: 86%; margin: 50px auto;">
            <div style="margin: 0 0 20px 30px;">
                Kính gửi<strong> {{ $title == 0 ? 'Ông' : 'Bà' }} <span>{{ $name }}</span></strong>,
            </div>
            <div>
                <div style="margin-bottom: 25px; text-align: justify; line-height: 1.38em;">
                    <span style="margin-left: 30px;">Thay mặt Ban tổ chức, Chúng tôi trân trọng kính mời
                        <strong>{{ $title == 0 ? 'Ông' : 'Bà' }} <span>{{ $name }}</span></strong> đến tham
                        dự</span>
                ...
                <div style="margin: 10px 0 5px 0"><strong>Thông tin chi tiết:</strong></div>

                <div
                    style="margin-bottom: 25px; text-align: justify; background: #f5f5f7; border-radius: 20px;padding: 20px 25px;">
                    <div><b>Hình thức tham dự:</b></div>
                    <div style="margin-top: 15px; text-transform: uppercase; text-align: center; color: #27c24c;">
                        <b>{{ $conference_fee_title }}</b>
                    </div>
                    @if ($obj == 'CB')
                        @switch($mail_type)
                            @case('LT')
                                <div style="margin-top: 15px;"><b>Thời gian:</b> Thứ bảy, ngày 20/06/2026</div>
                                <div style="margin-top: 10px;"><b>Địa điểm:</b> Khách sạn Royal Lotus Đà Nẵng</div>
                                <div style="margin-top: 10px;"><b>Địa chỉ:</b> 120A Nguyễn Văn Thoại, Mỹ An,
                                    Ngũ Hành Sơn, Đà Nẵng.</div>
                                <div style="margin-top: 10px;">
                                    <b>Lưu ý:</b> Tiệc Welcome dinner được tổ chức vào lúc <b>18:00</b> ngày <b>19/06/2026</b>
                                    tại
                                    <b>Khách sạn Royal Lotus Đà Nẵng</b> - 120A Nguyễn Văn Thoại, Mỹ An, Ngũ Hành Sơn, Đà Nẵng.
                                </div>
                            @break
                            ...
                            @case('CE')
                                <div style="margin-top: 15px;"><b>Thời gian:</b> Thứ bảy, ngày 20/06/2026</div>
                                <div style="margin-top: 10px;">
                                    <b>Lưu ý:</b> Link trực tuyến sẽ gửi qua email đăng ký trước ngày diễn ra hội nghị 1 - 3
                                    ngày.
                                    Vui lòng kiểm tra
                                    mail.
                                </div>
